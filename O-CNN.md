# Basic info
- Title: O-CNN: Octree-based Convolutional Neural Network for 3D Shape
- Author: Peng-Shuai Wang, Yang Liu, Yu-Xiao Guo, Chun_Yu Sun, Xin Tong
- Affiliation: Tsinghua University, Microsoft Research Asia & University of Electronic Science and Technology of China
...
- 3D shape modelled by irregular B-Rep, meshes or point clouds can not be utilised as an input for a machine learning algorithm such as CNN.
- Conversion to regularly sampled representation is required.
- Voxel-based methods are popular, however suffer from cubic memory and computation cost growth as resolution is increased.

## Idea / Observation / Contribution
- Paper proposes an **octree-based convolutional neural network** called *O-CNN*.
